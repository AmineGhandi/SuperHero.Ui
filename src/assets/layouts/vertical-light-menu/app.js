            ...
            togglethemeEl.addEventListener('click', function() {
                ...
                if (parseObj.settings.layout.darkMode) {
                    ...
                    if (!getUpdatedParseObject.settings.layout.darkMode) {
                        ...
                        if (ifStarterKit) {
                            document.querySelector('.navbar-logo').setAttribute('src', '../assets/../../src/assets/img/Asset 3.png')
                        } else {
                    ...
                    if (getUpdatedParseObject.settings.layout.darkMode) {
                        ...
                        if (ifStarterKit) {
                            document.querySelector('.navbar-logo').setAttribute('src', '../../src/assets/img/Asset 3.png')
                        } else {
